          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="font-bold text-foreground group-hover:text-blue-600 transition-colors text-sm break-all">
                  {email}
                </p>
              </div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="font-bold text-foreground group-hover:text-green-600 transition-colors">
                  {phone}
                </p>
              </div>
              <FaArrowRight className="text-foreground/30 group-hover:text-green-600 group-hover:translate-x-1 transition-all" />
            </div>
          </a>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              {/* Subject */}
              <div>
                <label htmlFor="subject" className="block text-sm font-semibold text-foreground/70 mb-2">
                  Subject *
                </label>
                <input
                  type="text"
              ...
              {/* Message */}
              <div>
                <label htmlFor="message" className="block text-sm font-semibold text-foreground/70 mb-2">
                  Message *
                </label>
                <textarea
                  id="message"
              ...
              <Button
                ...
                className="w-full flex items-center justify-center gap-3 rounded-xl font-bold text-lg hover:scale-[1.02] hover:shadow-lg transition-all duration-300 group border border-white/20 focus:-translate-y-1 focus:shadow-2xl"
              >
                Send Message
              ...
              {submitStatus === "success" && (
                <div className="p-5 rounded-xl text-center animate-slideIn" style={{ background: "rgba(34, 197, 94, 0.15)" }}>
